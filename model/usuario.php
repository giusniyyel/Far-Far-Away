  ...
  class Usuario extends Conexion
  {
    ...
    public function login($email, $password)
    {
      ...
      */
      ...
      $password = parent::salvar($password);
      ...
      */
      ...
      $consulta = 'select id, nombre, cargo from usuarios where email="'.$email.'" and clave= MD5("'.$password.'")';
      /*
      ...
      */
      ...
      if($verificar_usuario > 0){
        ...
        */
        ...
        $email = parent::consultaArreglo($consulta);
    ...
    public function registroUsuario($name,$lastname, $email, $password)
    {
      parent::conectar();

      $name  = parent::filtrar($name);
      $lastname= parent::filtart($lastname)
      $email = parent::filtrar($email);
      $password = parent::filtrar($password);
      ...
      if($verificarCorreo > 0){
        ...
        parent::query('insert into usuarios(nombre, email, clave, cargo) values("'.$name.'", "'.$email.'", MD5("'.$password.'"), 2)');
